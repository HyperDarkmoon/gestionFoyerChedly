...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
	...
	List<Reservation> findByChambres_Bloc_Foyer_Universite_NomUniversite(String nomUniversite);
	List<Reservation> findByAnneeUniversitaireAndChambres_Bloc_Foyer_Universite_NomUniversite(Date anneeUniversitaire, String nomUniversite);
}
